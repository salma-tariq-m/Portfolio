...
##  Installation
    1. Clone le projet :
       ```bash
       git clone https://github.com/salma-tariq-m/Portfolio.git


## Si ton projet utilise PHP :
    ```markdown
    - Place le dossier dans `htdocs` (XAMPP).
    - Démarre Apache et MySQL.
    - Ouvre `http://localhost/Portfolio/` dans ton navigateur.

## Fonctionnalités
    - Page d'accueil responsive
    - Section "À propos"
    - Liste de projets avec images
